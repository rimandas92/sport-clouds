module.exports =
    '<body style="padding: 0;margin: 0;font-family: Arial, Helvetica, sans-serif;">\
        <div style="width:600px;margin:0 auto;background-image: url({{ site_url }}uploads/email_template/top_bg.png);background-repeat: no-repeat;">\
            <div style="text-align: center;"><img style="margin-top: 5%;" src="{{ site_url }}uploads/email_template/logo.png" alt="fit4yoursport-logo"></div>\
            ...
            <div style="margin-top: -13px;margin-bottom: 42px; font-size: 14px;">\
                <p> Hi, {{ fname }} {{ lname }} </p>\
                <p>You have been added in team roster by a manager ,Please do login to check your position. </p>\
                <p>Please try to login on Sports Cloud app or web with below credentails. </p>\
                <p>User Name : {{ email }} </p>\
