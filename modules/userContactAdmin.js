module.exports =
    '<body style="padding: 0;margin: 0;font-family: Arial, Helvetica, sans-serif;">\
        <div style="width:600px;margin:0 auto;background-image: url({{ site_url }}uploads/email_template/top_bg.png);background-repeat: no-repeat;">\
            ...
            <div style="margin-top: -13px;margin-bottom: 42px; font-size: 14px;text-align: left;">\
            <ul style="list-style: none;">\
                <li style="color:#827f9e;font-size: 17px;">A user wants to contact with you .</li>\
                <li style="color:#827f9e;font-size: 17px;">Details are as  below : - <br><br></li>\
                <li style="color:#827f9e;font-size: 15px;"> Name : <b>{{ firstName }}  {{ lastName }}</b></li>\
                <li style="color:#827f9e;font-size: 15px;"> Email Address : <b>{{ email }}</li>\
                <li style="color:#827f9e;font-size: 15px;"> Phone Number : <b>{{ phone }}</li>\
                <li style="color:#827f9e;font-size: 15px;"> Message : <b>{{ message }} </li>\
            </ul>\
            </div>\
